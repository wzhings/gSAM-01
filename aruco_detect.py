...
# The dictionary type of your ArUco marker
ARUCO_DICT = cv2.aruco.DICT_4X4_1000

# The ID of your marker
MARKER_ID = 0

# 3. The actual physical size of the marker (need to confirm with the printed marker)
KNOWN_MARKER_WIDTH_CM = 10.0 #cm

# 4. The filename of your image
IMAGE_FILE = "photos/sample1.jpg"
...
scale, output_img = calculate_scale_factor(
    IMAGE_FILE, 
    ARUCO_DICT, 
    MARKER_ID, 
    KNOWN_MARKER_WIDTH_CM
)

# --- How to use the scale factor to measure the object (plant) ---
if scale:
    
    plant_width_pixels = 500 # we need to measure it automatically in practice
    
    # Real world width = Pixel width * Scale Factor
    plant_width_cm = plant_width_pixels * scale
    
    print(f"\nBased on the scale, the estimated real width of the plant is: {plant_width_cm:.2f} cm")
